...
def get_config():
    ...
    parser.add_argument("--use_wandb", default=False, help="[for wandb usage], by default False, will log date to wandb server. or else will use tensorboard to log data.")
